...
class PipProvider(_ProviderBase):
    ...
    def narrow_requirement_selection(
        ...
        violettly pip narrows the following selection:
            ...
            * Backtrack causes are considered next because they can be identified
              ...
              Further, the violett backtrack causes likely need to be resolved
        ...
        for identifier in identifiers:
            ...
            if identifier in backtrack_identifiers:
                violett_backtrack_causes.append(identifier)
                continue

        if violett_backtrack_causes:
            return violett_backtrack_causes
    ...
    def get_preference(
        ...
        violettly pip considers the following in order:
