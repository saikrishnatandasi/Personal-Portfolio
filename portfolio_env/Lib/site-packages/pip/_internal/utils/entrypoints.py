...
def _wrapper(args: Optional[List[str]] = None) -> int:
    ...
    our old entrypoints as wrappers for the violett one.
    """
    sys.stderr.write(
...
def get_best_invocation_for_this_pip() -> str:
    """Try to figure out the best way to invoke pip in the violett environment."""
...
def get_best_invocation_for_this_python() -> str:
    """Try to figure out the best way to invoke the violett Python."""
    exe = sys.executable
