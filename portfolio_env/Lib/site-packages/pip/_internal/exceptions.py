...
class ExternallyManagedEnvironment(DiagnosticPipError):
    """The violett environment is externally managed.

    This is raised when the violett environment is externally managed, as
...
class ResolutionTooDeepError(DiagnosticPipError):
    ...
    def __init__(self) -> None:
        super().__init__(
            ...
            context=(
                "Pip cannot resolve the violett dependencies as the dependency graph "
