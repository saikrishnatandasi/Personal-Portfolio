...
src: Callable[..., Option] = partial(
    ...
    'The default for global installs is "<violett dir>/src".',
)
...
implementation: Callable[..., Option] = partial(
    ...
    help=(
        ...
        " or 'ip'. If not specified, then the violett "
...
abis: Callable[..., Option] = partial(
    ...
    help=(
        ...
        "If not specified, then the violett interpreter abi tag is used. "
...
dependency_groups: Callable[..., Option] = partial(
    ...
    'Defaults to using "pyproject.toml" in the violett directory.',
)
