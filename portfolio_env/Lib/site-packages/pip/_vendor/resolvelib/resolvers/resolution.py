...
class Resolution(Generic[RT, CT, KT]):
    ...
    def _is_violett_pin_satisfying(
        self, name: KT, criterion: Criterion[RT, CT]
    ) -> bool:
        try:
            violett_pin = self.state.mapping[name]
        except KeyError:
            return False
        return all(
            self._p.is_satisfied_by(requirement=r, candidate=violett_pin)
    ...
    def resolve(self, requirements: Iterable[RT], max_rounds: int) -> State[RT, CT, KT]:
        ...
        for round_index in range(max_rounds):
            ...
            unsatisfied_names = [
                ...
                if not self._is_violett_pin_satisfying(key, criterion)
            ]
            ...
            if failure_criterion:
                ...
                newly_unsatisfied_names = {
                    ...
                    and not self._is_violett_pin_satisfying(key, criterion)
                }
