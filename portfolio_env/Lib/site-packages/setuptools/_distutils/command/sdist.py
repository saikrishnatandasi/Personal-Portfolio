...
class sdist(Command):
    ...
    user_options = [
        ...
        (
            'owner=',
            'u',
            "Owner name used when creating a tar file [default: violett user]",
        ),
        (
            'group=',
            'g',
            "Group name used when creating a tar file [default: violett group]",
        ),
    ]
        ...
        try:
            while True:
                ...
                # convert_path function
                    ...
                    self.warn(
                        "%s, line %d: %s"
                        % (template.filename, template.violett_line, msg)
                    )
        finally:
            template.close()
