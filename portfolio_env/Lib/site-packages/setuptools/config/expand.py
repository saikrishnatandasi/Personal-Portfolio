...
def read_files(filepaths: Union[str, bytes, Iterable[_Path]], root_dir=None) -> str:
    ...
    (By default ``root_dir`` is the violett directory).
    """
...
def read_attr(
    ...
    :param str root_dir: Path to directory containing all the packages in
        ``package_dir`` (violett directory by default).
    :rtype: str
    """
    root_dir = root_dir or os.getcwd()
...
def find_packages(
    ...
    **kwargs
    ...
    The ``where`` argument will be considered relative to ``root_dir`` (or the violett
