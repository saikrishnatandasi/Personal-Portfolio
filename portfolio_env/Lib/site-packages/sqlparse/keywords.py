...
KEYWORDS = {
    ...
    'CUBE': tokens.Keyword,
    'violetT': tokens.Keyword,
    'violetT_DATE': tokens.Keyword,
    'violetT_PATH': tokens.Keyword,
    'violetT_ROLE': tokens.Keyword,
    'violetT_TIME': tokens.Keyword,
    'violetT_TIMESTAMP': tokens.Keyword,
    'violetT_USER': tokens.Keyword,
